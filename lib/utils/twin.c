...
static PyMethodDef __pyx_mdef_5utils_11cython_twin_1twin_overlaps = {"twin_overlaps", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5utils_11cython_twin_1twin_overlaps, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5utils_11cython_twin_twin_overlaps};
 ...
 *         np.ndarray[DTYPE_t, ndim=2] query_wins):
 */
  __pyx_tuple__8 = PyTuple_Pack(10, __pyx_n_s_wins, __pyx_n_s_query_wins, __pyx_n_s_N, __pyx_n_s_K, __pyx_n_s_overlaps, __pyx_n_s_it, __pyx_n_s_ut, __pyx_n_s_win_len, __pyx_n_s_k, __pyx_n_s_n); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(2, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_utils_twin_pyx, __pyx_n_s_twin_overlaps, 15, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cython_twin(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cython_twin' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
